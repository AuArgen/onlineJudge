...
export default function CreateTopicPage() {
  ...
  return (
    <div className="max-w-xl mx-auto py-12 px-4">
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Жаңы тема түзүү</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-white border border-gray-200 rounded-xl p-6 space-y-5">
        ...
        <div>
          ...
          <input
            ...
            placeholder="Мисалы: Динамикалык программалоо"
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div>
                <p className="font-medium text-sm">Жашыруун</p>
                <p className="text-xs opacity-70">Ссылка же email менен</p>
              </div>
            </button>
            <button
              type="button"
            ...
            >
              ...
              <div>
                <p className="font-medium text-sm">Жалпы</p>
                <p className="text-xs opacity-70">Бардыгы көрө алат</p>
              </div>
            </button>
          </div>
        </div>
        ...
        <div className="flex gap-3 pt-2">
          ...
          >
            {loading ? 'Түзүлүп жатат...' : 'Тема түзүү'}
          </button>
          <Link
            href="/topics"
