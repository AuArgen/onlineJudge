...
export default function CreateContest() {
  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4">
      <h1 className="text-3xl font-bold text-gray-900 mb-8">{t('createContest.title')}</h1>

      <form onSubmit={handleSubmit} className="bg-white shadow rounded-lg p-6 space-y-6">
        <div>
          <label className="block text-sm font-medium text-gray-700">{t('createContest.name')}</label>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700">{t('createContest.description')}</label>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700">{t('createContest.start')}</label>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">{t('createContest.end')}</label>
